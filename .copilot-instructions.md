...
- Include UML class diagrams using PlantUML syntax directly in header files:
  - Use @startuml...@enduml blocks in class documentation
  - Focus on relationships between classes (inheritance, composition, aggregation)
  - Keep diagrams simple and focused on the specific class context
  - Example: @startuml ... class Episode ... @enduml
- Use Graphviz DOT for dependency and flow diagrams when needed:
  - Use @dot...@enddot blocks for custom graphs
  - Good for showing data flow and component relationships
...
- Graphviz dot (for dependency graphs and custom diagrams)
- PlantUML (for UML diagram generation in documentation)
